...
public final class QUICHandler {
    ...
    /// `quicStatelessResetTokenGenerator` with a persistent key using `.defaultWithUserProvidedKey(:)`
    ...
    ///   - quicStatelessResetTokenGenerator: The generator used to derive stateless reset tokens for each connection ID.
    /// - Returns: The handler and the connection multiplexer.
    public static func makeHandlerAndConnectionMultiplexer<Output: Sendable>(
        channel: any Channel,
        quicConfiguration: QUICConfiguration,
        ...
        quicStatelessResetTokenGenerator: any QUICStatelessResetTokenGenerator = .defaultWithAutoGeneratedKey
    ) throws -> (QUICHandler, QUICHandler.ConnectionMultiplexer<Output>) {
    ...
    private func createNewConnection(
        ...
        case .accepting:
            ...
            let quicConnection = try SwiftNetworkQUICConnection.client(
                ...
                quicStatelessResetTokenGenerator: self.quicStatelessResetTokenGenerator,
                serverName: serverName,
    ...
    private func trySendStatelessReset(
        ...
        let reset = self.quicStatelessResetTokenGenerator.statelessResetPacket(
